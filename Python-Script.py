...
if str(platform.system()) == 'Linux':
    os.system('figlet SemPAK-DDOS DDoS Attack')
else:
    os.system('pyfiglet SemPAK-DDOS  DDoS Attack')

print(Back.GREEN + Fore.GREEN +'[+] Anonymous DDoS tool by' + Fore.RED + 'Hupler                              ') 
print(Back.GREEN + Fore.BLACK + '[+] SemPAK-DDOS Tool BETA VERSION 0.1                                             ')
print(Back.BLACK +Fore.GREEN + '[+] SemPAK-DDoS Interactive Menu in Python by Hupli                   ')
print(Fore.YELLOW + '[+] I am hupli i always comeback                            ')
print(Fore.GREEN + '[+] Starting SemPAK-DDOS           ')
